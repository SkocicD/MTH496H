...
\begin{proof}
	...
	Label the angles as shown in THE FIGURE.
	...
	Since there is some 'b' greater than each 'a', the 'b' angles are lexiographically greater than the 'a' angles, hence $\overline{AC}$ is a thin edge.
...
So in this case, there is in some sense, two valid Delaunay triangulations.
We call these triangulations degenerate.
